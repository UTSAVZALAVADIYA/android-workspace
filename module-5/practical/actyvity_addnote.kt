...
import com.example.myapplication.databinding.ActivityActyvityAddnoteBinding

class actyvity_addnote : AppCompatActivity()
{
    private lateinit var binding: ActivityActyvityAddnoteBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        binding = ActivityActyvityAddnoteBinding.inflate(layoutInflater)
